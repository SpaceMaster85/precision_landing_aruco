...
private:
    ...
    float _target_lost_timer = 0.0f;
    float _target_lost_debounce = 0.5f; // Standardwert 0.5 s
	
	float _search_altitude = 10.0f;  // Höhe für Search-State
	float _search_layer_spacing = 2.0f;   // Abstand zwischen den Spiralschichten
